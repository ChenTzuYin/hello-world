...
means.df <- read.csv("means.df.MF02Target.csv", header =T)
...
##########
　　　　　　　　　　　　　　　　　　　　　　　　#onset内の時間区間の長さを調整
data$slapse <- ifelse(data$slapse < 2000, 2000, data$slapse)
data$elapse <- ifelse(data$elapse >= 3000, 3000, data$elapse)
　
